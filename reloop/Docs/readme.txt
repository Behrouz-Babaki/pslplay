...
The easiest way to get Sphinx to generate html files is to go into the Docs/ folder and execute the make file like this
    >>> make html

You can also clean the build directory by calling
    >>> make clean

However if you want to specify certain options as well as source and build directory you can call Sphinx from anywhere you'd like.
